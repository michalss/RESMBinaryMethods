...
namespace RESM.AlgosComps
{
    public class Algos
    {
        ...
        public byte[] Decompress(string algo, byte[] compressData, int zsize, int size = 0)
        {
            if (size == 0)
            {
                size = _buffer; // use 1 MB if not sure
        ...
        public byte[] Decompress(string algo, byte[] dictionary, byte[] compressedData, int size = 0)
        {
        ...
        public byte[] Compress(string algo, byte[] decompressedData, int size = 0)
        {
            byte[] compressedData;
        ...
        public byte[] Compress(string algo, byte[] dictionary, byte[] decompressedData, int size = 0)
        {
            byte[] compressedData;
            if (decompressedData.Length == 0)
            {
        ...
        public byte[] Encryption(string type, ref byte[] key, ref byte[] ivec, ref byte[] inputData)
        {
            byte[] outputData;
            if (inputData.Length == 0)
            {
        ...
        public byte[] Decryption(string type, ref byte[] key, ref byte[] ivec, ref byte[] inputData)
        {
            byte[] outputData;
            if (inputData.Length == 0)
            {
